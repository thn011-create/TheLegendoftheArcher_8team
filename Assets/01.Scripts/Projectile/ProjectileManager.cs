...
public class ProjectileManager : MonoBehaviour
{
    ...
    public void ShootBullet(RangeWeaponHandler rangeWeaponHandler, Vector2 startPosition, Vector2 direction, int key)
    {
        ...
        projectileController.Init(direction, rangeWeaponHandler, this, key);
    }
